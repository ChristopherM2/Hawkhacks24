...
client.on('messageCreate',async msg =>{
	//await client.guilds.cache.get('1019673392221261844').members.cache.get('481260726703620106').send({content:`${msg.author}: ${msg.content}`})
	 
	if(msg.content.includes('meow')&& msg.author.id!=739699822923087963){
		msg.reply({content:'meow'})
	}
})
